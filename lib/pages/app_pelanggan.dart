...
import '../widgets/navigation_buttons_pelanggan.dart';

class App_pelanggan extends StatefulWidget {
  const App_pelanggan({super.key});

  @override
  _AppState createState() => _AppState();
}

class _AppState extends State<App_pelanggan> {
